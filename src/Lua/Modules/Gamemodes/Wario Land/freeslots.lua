...
-- Objects
"MT_WLPORTALSMALL_ALT","MT_WLPORTALMEDIUM_ALT","MT_WLPORTALLARGE_ALT","MT_KOMBIFROGSWITCH_ALT","MT_COINLOSSEFFECT_ALT","MT_FROGSWITCHANIMATOR_ALT","MT_WLPORTALSPAWNER",
-- Longsprites
...
mobjinfo[MT_COINLOSSEFFECT_ALT] = {
